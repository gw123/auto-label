...
import { X, Plus, Save, Trash2, CheckCircle, XCircle, Globe, Key, Server, Cpu, Play } from 'lucide-react';
...
export const ModelManagerModal: React.FC<ModelManagerModalProps> = ({
  isOpen, onClose, models, onSaveModels, activeModelId, onSetActiveModel
}) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-neutral-900 w-full max-w-4xl h-[85vh] rounded-xl border border-neutral-700 shadow-2xl flex flex-col overflow-hidden">
        
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-neutral-800 bg-neutral-950">
          <div>
            <h2 className="text-xl font-bold text-white flex items-center gap-2">
              <Cpu size={24} className="text-blue-500" /> AI Model Manager
            </h2>
            <p className="text-xs text-neutral-400">Manage connection to Google, OpenAI, Ollama and custom endpoints.</p>
          </div>
